...
Этот файл — обязательные правила работы над **LucidSSH for Windows**. Читается перед каждой задачей. При конфликте: ТЗ (`doc/TZ.md`) и реализованный UI в `src/renderer/components/` имеют приоритет над этим файлом, этот файл — над общими привычками.
