...
**Блокер релиза:** BLK-01 — сертификат подписи кода (закрыт 08.07.2026: решение — релиз без подписи, SHA-256 вместо подписи). Подробно см. BLK-01 в TZ.md §11.1 и раздел 9 Release_and_Update_Strategy.md.
