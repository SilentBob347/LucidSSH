...
/**
 * Набор векторных иконок из финального дизайна (docs/Final design/LucidSSH.dc.html) —
 * stroke-based, стиль Lucide, 24×24, наследуют цвет через currentColor. Единый
 * источник вместо эмодзи по всему UI (аудит дизайна).
 */
...
const PATHS: Record<IconName, JSX.Element> = {
  ...
  restore: (
    <>
      ...
      <path d="M16 8h-8a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2v-2" />
    </>
  ),
  help: (
    <>
