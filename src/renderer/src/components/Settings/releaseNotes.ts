 ...
 * на секции `## RU` / `## EN` — формат зафиксирован в
 * Release_and_Update_Strategy.md §6.1 (обязателен для release notes каждого
 * релиза начиная с этой темы, «changelog при обновлении»). Без markdown-
