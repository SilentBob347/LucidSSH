...
SFTP-браузер, Mosh, Telnet, RDP, VNC, X11, Serial, облачная синхронизация, мобильная версия, локальный PowerShell/CMD/WSL-терминал — запланированы в следующих версиях или не планируются вовсе. LucidSSH остаётся SSH-клиентом, а не универсальным эмулятором терминала.
...
- [Техническое задание](docs/TZ.md) — список реализованных требований с приоритетами и критериями приёмки
- [Руководство по безопасности](docs/Security_Guide.md) — модель безопасности и правила реализации
- [Сборка и обновления](docs/Release_and_Update_Strategy.md) — публикация, подпись, автообновление
- [Схемы данных](docs/Data_Structures.md) — хранилища, форматы встроенных баз, IPC-контракт
...
Исходный код опубликован для ознакомления, аудита и обратной связи.
Лицензия использования пока не определена — репозиторий публичный,
но код нельзя копировать, изменять или распространять без отдельного
разрешения автора. Как только модель распространения определится,
